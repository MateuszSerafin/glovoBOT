...
public class deviceID {
    ...
    public deviceID(container container, urlhelper urlhelp, String androidToken, String gcmToken, String gpsToken, String mac){
    ...
    public boolean deviceIDcon(){
        ...
        try{
            reponse probablyJson = this.urlhelp.reqZwejsciemiwyjesciem(urlhelper.glovoURL.DEVICEID.gettype(), urlhelper.requestTYP.POST.getUrl(), jsonToSend.getBytes(StandardCharsets.UTF_8), true, false);
            ...
            System.out.println(String.format("Failed getting device ID for %s", containerInstance.getEmail()));
            return false;
        }
    }
}
